...
let userID = "8520394f-9d3c-4203-aa7e-af86899c93f5";

const proxyIPs = ["8.219.248.47"]; //ts.hpc.tw edgetunnel.anycast.eu.org bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org proxy.xxxxxxxx.tk
const cn_hostnames = [''];
